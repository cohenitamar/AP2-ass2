...
function UserInput({u1, u2, setUsername}) {
    ...
    return (
        ...
        <div className="inputUser">
            ...
            <InputVal inputType="text" iconType="bi bi-person" inputRef={userInput} func={handleKeyPress} checkUser={checkUser}/>
            <div className="mb-2 pt-2">{u2}</div>
            <InputVal inputType="password" iconType="bi bi-lock" inputRef={password} func={handleKeyPress} innerIcon1="bi bi-eye iconPassword" innerIcon2="bi bi-eye-slash iconPassword" checkPassword={checkPassword}
